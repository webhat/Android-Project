...
public class SettingNotifyLayout extends DialogPreference{
	...
	public static int getNotifyButtonID(int position, int button)
	{
		...
		case 0:
			switch(button)
			{
			case 0: return R.id.noti_0_up;
			case 1: return R.id.noti_0_down;
			case 2: return R.id.noti_0_pause;
			case 3: return R.id.noti_0_close;
			}
			break;
		case 1:
			switch(button)
			{
			case 0: return R.id.noti_1_up;
			case 1: return R.id.noti_1_down;
			case 2: return R.id.noti_1_pause;
			case 3: return R.id.noti_1_close;
			}
			break;
		case 2:
			switch(button)
			{
			case 0: return R.id.noti_2_up;
			case 1: return R.id.noti_2_down;
			case 2: return R.id.noti_2_pause;
			case 3: return R.id.noti_2_close;
			}
			break;
		case 3:
			switch(button)
			{
			case 0: return R.id.noti_3_up;
			case 1: return R.id.noti_3_down;
			case 2: return R.id.noti_3_pause;
			case 3: return R.id.noti_3_close;
			}
			break;
		}
		return 0;
		...
		public boolean onDrag(View v, DragEvent event) {
			...
			case DragEvent.ACTION_DRAG_LOCATION:
				...
				if(mDstSlot != slot)
				{
					...
					switch(slot)
					{
					case 0: mCurrentOrder = String.valueOf(mItem) + tempOrder; break;
					case 1: mCurrentOrder = tempOrder.substring(0, 1) + String.valueOf(mItem) + tempOrder.substring(1, 3); break;
					case 2: mCurrentOrder = tempOrder.substring(0, 2) + String.valueOf(mItem) + tempOrder.substring(2, 3); break;
					case 3: mCurrentOrder = tempOrder + String.valueOf(mItem); break;
					}
					Log.e(Dimmer.TAG, "mCurrentOrder= " + mCurrentOrder + ", tempOrder=" + tempOrder + ", mItem=" + mItem);
